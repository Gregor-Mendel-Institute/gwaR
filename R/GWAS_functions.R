...
plot_anchored_ld <-   function(gwas_table,
  ...
  anc_ld <- snp_linkage(gwas_table = gwas_table, rank = rank, nuc_range = nuc_range, anchored = TRUE, use_phenotype_table = use_phenotype_table, use_all_acc = use_all_acc , ld_stats = ld_stats)
